...
public class OpenReadCustomerPage extends AbstractAction {
	JFrame frame;
	String text;

	public OpenReadCustomerPage(JFrame frame, String text){
		super(text);
		this.frame = frame;
	}

	public void actionPerformed(ActionEvent e) {
		new ReadCustomerPage(frame, text);
	}


	public class ReadCustomerPage extends JFrame {
		JFrame frame;
		Container mainPanel;
		Container middlePanel;

		public ReadCustomerPage(JFrame frame, String texte){
			super(texte);
			this.frame = frame;
			...
			JLabel labelCustomerNameOrPhone = new JLabel("Customers will be listed here");          
