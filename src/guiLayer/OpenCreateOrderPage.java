...
import controllerLayer.SaleOrderController;
...
public class OpenCreateOrderPage extends AbstractAction {
	JFrame frame;
	String text;
	SaleOrderController orderController;
	CustomerController customerController;

	public OpenCreateOrderPage(JFrame frame, String text){
		super(text);
		this.frame = frame;
	}
	...
	public void actionPerformed(ActionEvent e) {
		try {
			new CreateOrderPage(frame, text);
			orderController = new SaleOrderController(null, null);
...
////////////////////////////////////////////////////////
	...
	public class CreateOrderPage extends JFrame {
		...
		public CreateOrderPage(JFrame frame, String texte) throws DataAccessException{
